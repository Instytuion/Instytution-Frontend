              ...
              >
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    bgcolor: "#FFCCCB", // Light red color code
                    fontSize: ["0.75rem", "0.75rem", "1rem"],
                    color: selectedStock < 20 ? "red" : "",
                    mb: 1,
                    // p: 0.5, // Optional: Add some padding for better readability
                    px:2
                  }}
                >
...
// import React, { useState, useEffect } from "react";
// import { Card, CardMedia, CardContent, Typography, Grid, Box, Tooltip } from "@mui/material";
// import { useNavigate } from "react-router-dom";
// import { Carousel } from "react-responsive-carousel";
// import "react-responsive-carousel/lib/styles/carousel.min.css";
// import { ArrowBackIos, ArrowForwardIos } from "@mui/icons-material";
...
//   const getUniqueSizes = (details) => {
//     const sizeSet = new Set(details.map((detail) => detail.size).filter((size) => size));
//     return [...sizeSet];
//   };
...
//         const colorImages = getImagesBySelectedColor();
//         const availableColorsForSize = getAvailableColorsForSize(item, selectedSize);

//         useEffect(() => {
//           if (!availableColorsForSize.has(selectedColor) && availableColorsForSize.size > 0) {
//             const firstAvailableColor = [...availableColorsForSize][0];
//             setSelectedColor(firstAvailableColor);
//           }
...
//                   }}
//                 >
//                   Price: ${item.details[0]?.price || "N/A"}
//                 </Typography>
...
//                   {getUniqueColors(item.images).map((color, i) => (
//                     <Tooltip
//                       title={availableColorsForSize.has(color) ? "" : "This Is Currently Unavailable"}
//                       arrow
//                       key={i}
//                     >
//                       <Box
//                         onClick={() => availableColorsForSize.has(color) && setSelectedColor(color)}
//                         sx={{
//                           width: "20px",
//                           height: "20px",
//                           borderRadius: "50%",
//                           backgroundColor: color.toLowerCase(),
//                           marginLeft: 1,
//                           boxShadow: availableColorsForSize.has(color) ? "0 0 5px rgba(0, 0, 0, 0.5)" : "0 0 5px rgba(255, 0, 0, 0.5)",
//                           cursor: availableColorsForSize.has(color) ? "pointer" : "not-allowed",
//                           border: `2px solid ${selectedColor.toLowerCase() === color.toLowerCase() ? "#000" : "#f2f2f2"}`,
//                           opacity: availableColorsForSize.has(color) ? 1 : 0.3,
//                         }}
//                       />
//                     </Tooltip>
...
//                       onClick={() => {
//                         setSelectedSize(size);
//                         // Update color if the current selected color is not available for the new size
...
//                         boxShadow: "0 1px 2px rgba(0, 0, 0, 0.1)",
//                         "&:hover": {
//                           backgroundColor: selectedSize === size ? "#000" : "#e0e0e0",
//                           color: selectedSize === size ? "#fff" : "#000",
//                         },
//                       }}
//                     >
